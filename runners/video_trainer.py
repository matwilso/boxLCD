...
from nets.pixels import AutoWorldModel, AutoWorld2
...
class VideoTrainer(Trainer):
  ...
  def sample(self, i):
    ...
    if True:
      ...
      self.writer.add_video('samples', self.force_shape(sample), i, fps=50)
    ...
    if True:
      ...
      self.writer.add_video('prompted', self.force_shape(out), i, fps=50)
