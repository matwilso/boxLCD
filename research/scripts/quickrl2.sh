...
#python rl/sac.py --env=Luxo --model=FlatRonald --weightdir=logs/april22a/video/FlatRonald/Luxo/ --window=50 --goals=1 --num_envs=12 --lenv=1 --logdir=logs/april23/rl/luxo/lenv/fix/ronald/0.005/0.5temp --lenv_temp=0.5 --bs=256 --hidden_size=512 --reset_prompt=1 --succ_reset=0 --total_steps=100000 --goal_thres=0.005
#
#python rl/sac.py --env=Luxo --model=FlatBToken --weightdir=logs/april22a/video/FlatBToken/Luxo/ --window=50 --goals=1 --num_envs=12 --lenv=1 --logdir=logs/april23/rl/luxo/lenv/fix/btoken/0.005/0.1temp --lenv_temp=0.1 --bs=256 --hidden_size=512 --reset_prompt=1 --succ_reset=0 --total_steps=100000 --goal_thres=0.005
#
#python rl/sac.py --env=Luxo --model=FlatBToken --weightdir=logs/april22a/video/FlatBToken/Luxo/ --window=50 --goals=1 --num_envs=12 --lenv=1 --logdir=logs/april23/rl/luxo/lenv/fix/btoken/0.005/0.5temp --lenv_temp=0.5 --bs=256 --hidden_size=512 --reset_prompt=1 --succ_reset=0 --total_steps=100000 --goal_thres=0.005
#
python rl/sac.py --env=Luxo --model=FlatRonald --weightdir=logs/april22a/video/FlatRonald/Luxo/ --window=50 --goals=1 --num_envs=12 --lenv=1 --logdir=logs/april23/rl/luxo/lenv/fix/ronald/0.005/1.2temp_again --lenv_temp=1.2 --bs=256 --hidden_size=512 --reset_prompt=1 --succ_reset=0 --total_steps=100000 --goal_thres=0.005
python rl/sac.py --env=Luxo --model=FlatRonald --weightdir=logs/april22a/video/FlatRonald/Luxo/ --window=50 --goals=1 --num_envs=12 --lenv=1 --logdir=logs/april23/rl/luxo/lenv/fix/ronald/0.005/0.1temp_again --lenv_temp=0.1 --bs=256 --hidden_size=512 --reset_prompt=1 --succ_reset=0 --total_steps=100000 --goal_thres=0.005
#
#
