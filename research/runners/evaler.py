...
class Evaler:
    ...
    def run(self):
        ...
        with torch.no_grad():
            ...
            for key, val in testu.items():
                print(f'{key}: {val[0]}  +/-  {val[1]}')
            print()
            print('Test Prompted' + '-' * 15)
            for key, val in testp.items():
                print(f'{key}: {val[0]}  +/-  {val[1]}')
            ...
            for key, val in trainu.items():
                print(f'{key}: {val[0]}  +/-  {val[1]}')
            print()
            print('Train Prompted' + '-' * 15)
            for key, val in trainp.items():
                print(f'{key}: {val[0]}  +/-  {val[1]}')
