...
class ResnetBlock(nn.Module):
    def __init__(
        ...
        **attn_kwargs
        ...
        self.gca = (
            GlobalContext(dim_in=dim_out, dim_out=dim_out) if use_gca else Constant(1)
        )
...
class LinearAttentionTransformerBlock(nn.Module):
    def __init__(
        self, dim, *, depth=1, heads=8, dim_head=32, ff_mult=2, context_dim=None, **kwargs
    ):
        super().__init__()
        self.layers = nn.ModuleList([])
