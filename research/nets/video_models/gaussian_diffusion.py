...
class GaussianDiffusion:
  ...
  def p_sample(self, model, shape, noise=None, model_kwargs={}, prompts=None, prompt_n=None):
...
class Extractable:
  ...
  def __getitem__(self, t):
    ...
    return res[:, None, None, None, None]  # reshape (BS,) --> (BS, T=1, C=1, H=1, W=1) to make image size
