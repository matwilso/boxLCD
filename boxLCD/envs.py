...
class Dropbox(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[], objects=[Object('object0', shape='box', size=0.7, density=0.1)]
        )
        super().__init__(w, G)
...
class Bounce2(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            ...
            objects=[
                Object(
                    f'object{i}', shape='circle', size=0.5, density=0.1, restitution=0.8
                )
                for i in range(2)
            ],
        )
...
class Object2(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            ...
            objects=[
                Object(
                    f'object{i}', shape='random', size=0.5, density=0.1, restitution=0.8
                )
                for i in range(2)
            ],
        )
...
cube_settings = dict(
    shape='box', size=0.4, density=0.5, linearDamping=1.0, angularDamping=0.2
)
...
class UrchinCube(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='urchin', name='urchin0')],
            objects=[Object(f'object{i}', **cube_settings) for i in range(1)],
        )
        super().__init__(w, G)
...
class LuxoCube(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='luxo', name='luxo0')],
            objects=[Object(f'object{i}', **cube_settings) for i in range(1)],
        )
        super().__init__(w, G)
...
class UrchinBall(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='urchin', name='urchin0')],
            objects=[Object('object0', **ball_settings)],
        )
...
class UrchinBalls(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='urchin', name='urchin0')],
            objects=[Object(f'object{i}', **ball_settings) for i in range(3)],
        )
        super().__init__(w, G)
...
class UrchinCubes(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='urchin', name='urchin0')],
            objects=[Object(f'object{i}', **cube_settings) for i in range(3)],
        )
        super().__init__(w, G)
...
class CrabCube(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='crab', name='crab0')],
            objects=[
                Object(f'object{i}', shape='box', size=0.4, density=1.0, friction=1.0)
                for i in range(1)
            ],
        )
        super().__init__(w, G)
...
class SpiderCube(WorldEnv):
    def __init__(self, G={}):
        w = WorldDef(
            robots=[Robot(type='spider', name='spider0')],
            objects=[
                Object(f'object{i}', shape='box', size=0.3, density=0.1, friction=1.0)
                for i in range(1)
            ],
        )
        super().__init__(w, G)
